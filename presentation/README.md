...
| `index-en.pdf` / `index-ko.pdf` | **PDF exports** (one slide per page) — backup / easy to email. No speaker notes or transitions; present from the HTML for those. Re-export after edits: load `index-<lang>.html?print-pdf` and Print → Save as PDF (or ask me). |
