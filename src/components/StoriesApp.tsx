...
export default function StoriesApp() {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      // Canvas data URL = solid near-black ocean with no Three.js side-effects.
      // showAtmosphere(false) prevents any warm/orange glow wrapping the sphere.
      ...
      setTimeout(() => { const c = globe.controls?.(); if (c) { c.autoRotate = true; c.autoRotateSpeed = 0.25; c.enableZoom = true } }, 100)
