  ...
  return (
    <PageShell>
      ...
      {INCOMPLETE && (
        <div style={{ background: 'rgba(200,120,85,0.06)', border: `1px solid ${C.clay}55`, borderRadius: 10, padding: '14px 18px', marginBottom: 40 }}>
          ...
          <div style={{ fontSize: '0.82rem', color: C.textMuted, lineHeight: 1.6 }}>
            ...
            <code style={{ fontFamily: "'Courier New', monospace", fontSize: '0.85em', color: C.text }}>src/app/(pages)/impressum/page.tsx</code>{' '}
      ...
      <Section title="Image credits (Bildnachweise)">
        ...
        <Link href="/learn" style={{ color: C.textMuted, borderBottom: `1px solid ${C.border}`, textDecoration: 'none' }}>the glossary</Link> and the in-app source badges.
      </Section>
      ...
      <Section title="Copyright">
        ...
        <a href="https://github.com/nyahn01/provenance-tracker" style={{ color: C.textMuted, borderBottom: `1px solid ${C.border}`, textDecoration: 'none' }}>repository</a> and its
